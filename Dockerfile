FROM odoo:latest
COPY ./logo.png /usr/lib/python3/dist-packages/odoo/addons/point_of_sale/static/src/img/logo.png
COPY ./favicon.ico /usr/lib/python3/dist-packages/odoo/addons/point_of_sale/static/src/img/favicon.ico
COPY ./logo.png /usr/lib/python3/dist-packages/odoo/addons/web/static/img/logo.png
COPY ./logo.png /usr/lib/python3/dist-packages/odoo/addons/web/static/img/logo_inverse_white_206px.png
COPY ./logo.png /usr/lib/python3/dist-packages/odoo/addons/web/static/img/logo2.png
